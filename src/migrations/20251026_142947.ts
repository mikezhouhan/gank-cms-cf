...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."_locales" AS ENUM('en', 'zh-CN', 'de');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_published_locale" AS ENUM('en', 'zh-CN', 'de');
  ...
  CREATE INDEX "posts_meta_meta_image_1_idx" ON "posts_locales" USING btree ("meta_image_id","_locale");
  ...
  CREATE INDEX "_posts_v_version_meta_version_meta_image_1_idx" ON "_posts_v_locales" USING btree ("version_meta_image_id","_locale");
